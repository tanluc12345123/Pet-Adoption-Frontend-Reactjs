...
const ModalEdit = ({ open, handleClose, setLoading, handleReload, types, schedule, typeSchedule }) => {
    ...
    const updateSchedule = async () => {
        if (description != '') {
            try {
                ...
                const response = await Api.updateSchedule(schedule.id, scheduleUpdate)
                if (response.data.status === "Success") {
                    setAlert(true)
                    handleReload()
                }
    ...
    return (
        ...
        >
            ...
            <DialogActions>
                <Button autoFocus onClick={updateSchedule}>
                    Save changes
                </Button>
            </DialogActions>
